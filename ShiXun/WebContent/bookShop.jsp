...
<option>《Strues2+Hibernate框架技术教程》</option>
<option>《wed框架技术（Strues2+Hibernate+Spring3）教程》</option>
<option>《Java Wed技术整合应用与项目实战（JSP+Servlet+Strues2+Hibernate+Spring3）》</option>
